...
void npShapeVslnN_13TeV(){
  ...
  string filePath = "/home/rverma/t3store3/AN-18-061/ExclusionLimit/CMSSW_8_0_26/src/HiggsAnalysis/HplusTocs13TeVLimit/limit/mu_ele/";
  ...
  for(itr = mjjFiles.begin(); itr!= mjjFiles.end(); itr++){
    ...
    TH1F* hBkgbcTagUp2 = getAllBkgHist(f, "_bcTag2Up");
    TH1F* hBkgbcTagDown2 = getAllBkgHist(f, "_bcTag2Down");
    TH1F* hBkgbcTagUp1 = getAllBkgHist(f, "_bcTag1Up");
    TH1F* hBkgbcTagDown1 = getAllBkgHist(f, "_bcTag1Down");
    TH1F* hBkgbcTagUp3 = getAllBkgHist(f, "_bcTag3Up");
    TH1F* hBkgbcTagDown3 = getAllBkgHist(f, "_bcTag3Down");
    ...
    TH1F* hSigbcTagUp2 = getHisto(f, "WH120_bcTag2Up");
    TH1F* hSigbcTagDown2 = getHisto(f, "WH120_bcTag2Down");
    TH1F* hSigbcTagUp1 = getHisto(f, "WH120_bcTag1Up");
    TH1F* hSigbcTagDown1 = getHisto(f, "WH120_bcTag1Down");
    TH1F* hSigbcTagUp3 = getHisto(f, "WH120_bcTag3Up");
    TH1F* hSigbcTagDown3 = getHisto(f, "WH120_bcTag3Down");
