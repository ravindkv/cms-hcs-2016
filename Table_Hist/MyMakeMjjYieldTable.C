...
bool forPaper = true;
///INPUT FILES
TString muDir = "stack_20200307_Mu_CWR";
TString eleDir = "stack_20200307_Ele_CWR";
...
void MyMakeMjjYieldTable(){
  ...
  outFile<<"\\hline "<<endl;
  outFile<<"\\hline "<<endl;
  outFile<<getRowInc("$m_{\PSHp}=80$  \\GeV", fMuWH80, fEleWH80, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=90$  \\GeV", fMuWH90, fEleWH90, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=100$ \\GeV", fMuWH100, fEleWH100, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=120$ \\GeV", fMuWH120, fEleWH120, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=140$ \\GeV", fMuWH140, fEleWH140, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=150$ \\GeV", fMuWH150, fEleWH150, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=155$ \\GeV", fMuWH155, fEleWH155, "mjj_kfit")<<endl;
  outFile<<getRowInc("$m_{\PSHp}=160$ \\GeV", fMuWH160, fEleWH160, "mjj_kfit")<<endl;
  outFile<<"\\hline "<<endl;
  ...
  outFile<<"\\hline "<<endl;
  outFile<<"\\hline "<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=80$ \\GeV", fMuWH80, fEleWH80, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=90$ \\GeV", fMuWH90, fEleWH90, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=100$ \\GeV", fMuWH100, fEleWH100, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=120$ \\GeV", fMuWH120, fEleWH120, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=140$ \\GeV", fMuWH140, fEleWH140, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=150$ \\GeV", fMuWH150, fEleWH150, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=155$ \\GeV", fMuWH155, fEleWH155, "mjj_kfit_CTagIncL")<<endl;
  outFile<<getRowInc("$m_{\\PSHp}=160$ \\GeV", fMuWH160, fEleWH160, "mjj_kfit_CTagIncL")<<endl;
  outFile<<"\\hline "<<endl;
  ...
  outFile<<"\\hline "<<endl;
  outFile<<"\\hline "<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=80$ \\GeV", fMuWH80, fEleWH80)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=90$ \\GeV", fMuWH90, fEleWH90)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=100$ \\GeV", fMuWH100, fEleWH100)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=120$ \\GeV", fMuWH120, fEleWH120)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=140$ \\GeV", fMuWH140, fEleWH140)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=150$ \\GeV", fMuWH150, fEleWH150)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=155$ \\GeV", fMuWH155, fEleWH155)<<endl;
  outFile<<getRowEx("$m_{\\PSHp}=160$ \\GeV", fMuWH160, fEleWH160)<<endl;
  outFile<<"\\hline "<<endl;
