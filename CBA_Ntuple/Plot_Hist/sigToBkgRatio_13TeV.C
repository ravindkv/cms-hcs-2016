...
void oneSigToBkgRatio(TFile *fSig, TString mass, int xMin, int yMax){
  ...
  hRatioInc->SetTitle("");
  hRatioInc->GetYaxis()->SetRangeUser(0.001, yMax);
...
void sigToBkgRatio_13TeV(){
  oneSigToBkgRatio(fSig80, "WH80", 20,  10);
  oneSigToBkgRatio(fSig90, "WH90", 20,  10);
  oneSigToBkgRatio(fSig100, "WH100",20,  10);
  oneSigToBkgRatio(fSig120, "WH120",20,  10);
  oneSigToBkgRatio(fSig140, "WH140",20,  10);
  oneSigToBkgRatio(fSig150, "WH150",20,  10);
  oneSigToBkgRatio(fSig155, "WH155",20,  10);
  oneSigToBkgRatio(fSig160, "WH160",20,  100);
}
